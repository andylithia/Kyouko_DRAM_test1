...
int ddrc_reg_values[2*80] = {
    0xf8006000, 0,      //   16: ddrc_ctrl at 0x0				DDR_LOW_BASE
    ...
    0xf8006058, 0,      //   36: DLL_calib at 0x58						DLL Calibration Ratio
    0xf800605c, 0,      //   37: ODT_delay_hold at 0x5C					16-bit ODT Delay and ODT Hold
...
int R50 = DDR_LOW_BASE + 0x140;	// 0x140~0x14F: [3:0] phy_rd_dqs_cfg
int R55 = DDR_LOW_BASE + 0x154; // 0x154~0x163: [3:0] R055_reg_phy_wr_dqs_slave_ratio  R055[9:0]
  ...
  if (test_mode == 1) // standalone diag
  {
    ...
    while (1)
    {
      ...
      else
      {
        ...
        int dqs = get_reglist_value(&ddrc_reg_values[0], 80, R55 + 4*0, 0, 10);
        printf("R55: %X\n", dqs);
